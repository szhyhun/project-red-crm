...
- [Client portal build plan](client-portal-plan.md): the design briefs read against the schema, the capability authorization model, the multi-board design, and the T1–T13 task breakdown.
