...
RSpec.describe "Listing operations", type: :request do
  ...
  it "keeps the production board scoped to the signed-in organization" do
    own_task = WorkflowTask.create!(organization:, board: organization.default_board, listing:, title: "Edit hero video")
    ...
    WorkflowTask.create!(organization: other_organization, board: other_organization.default_board, listing: other_listing, title: "Hidden task")
